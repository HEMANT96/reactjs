...
function Accrdion(){
    return(
        <div className="contianer-fluid body">
             <Accordion className="mt-2 ">
                        <Card className="border rounded" >
                            <Accordion.Toggle  className="color text-white ml-0 p-2" eventKey="0">PlayIn
                            <p className="ml-0 col-sm-2 mb-0 mr-5 text-white pl-0"></p>
                            </Accordion.Toggle>
                        ...
                        <Card className="mt-1  border rounded">
                            <Accordion.Toggle className="color d-flex ml-o pt-1 pb-2 text-white pr-0" eventKey="2">Tennis
