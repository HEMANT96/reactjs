...
function Marketpl(){
    return(
      ...
      <div class="right_col" role="main">
	    <div class="col-md-12">
		<div class="title_new_at">  Market PL </div>
	    </div>
		...
		<form method="post" class="form-horizontal form-label-left mr-0 input_mask" id="formSubmit"><input type="hidden" name="compute" value="fe6602731bf3d65605f0d8f6552a1c9f"/> 		  
			...
			<input type="text" name="from_date" value="2020-06-30 00:00:00" id="from-date" class="form-control mr-0 col-md-7 col-xs-12 has-feedback-left datetimepicker" placeholder="From date" autocomplete="off"  />
		    </div>
		    <div class="popup_col_2 mx-0 pr-0">
			<input type="text" name="to_date" value="2020-06-30 11:46:46" id="to-date" class="form-control mr-0 col-md-7 col-xs-12 has-feedback-left datetimepicker" placeholder="To date" autocomplete="off"  />
		    </div>
		...
		<div class="custom-scroll data-background appendAjaxTbl">
		    ...
		    <table class="table table-striped jambo_table bulk_action" id = "Marketdatatable">
                <thead>		
			<tr>				
				<th class="">Date </th>
				<th class="">Market </th>
