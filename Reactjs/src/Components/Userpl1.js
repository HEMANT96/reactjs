...
function Userpl1(){
    ...
    <div class="right_col" role="main">
	    <div class="col-md-12">
		<div class="title_new_at"> User's PL 
		<div class="pull-right"><button class="btn btn-xs btn-primary"  id="backbutton">Back</button></div>
		</div>
	    </div>
		...
		<div id="betsalltab" class="tab_bets">
			<div class="nav nav-pills match-lists">	
				...
				<input type="hidden" id="inputFilterDate" name="Filterdate" value="t"/>
			</div>
		</div>		 
		</div>	
		</form>
