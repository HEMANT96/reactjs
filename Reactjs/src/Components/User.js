   ...
   <div class="col-md-12">
      <div class="title_new_at">
         ...
         <form class="usersech user-mobile" id="formSubmit" method="post"><input type="hidden" name="compute" value="fe6602731bf3d65605f0d8f6552a1c9f"/>
            ...
            <button class="fa fa-search" id="submit_form_button" data-attr="submit"></button>
         </form>
         ...
         <button class="btn btn-warning ml-1 btn-xs" onclick="setAction()" >
         ACTION
         </button>
                        </div>
   </div>
               ...
               <div class="custom-scroll appendAjaxTbl">
                  <table class="table table-striped jambo_table bulk_action" id="datatabless">
                     ...
                     <tbody>
                           ...
                           <td class=" ">20000 </td>
                           <td class=" "><NavLink class="btn btn-success btn-xs" to=" http://park9.bet/report/openbethistory?user_id=152262&Usertype=4"> 0.00</NavLink>
                           </td>
                           <td class=" ">20000 </td>
                           <td class=" ">0.00</td><td class=" ">0.00</td>                  
                                             <td class="last">
							<span class="dropdown">
							  <NavLink to="#" class="dropdown-toggle btn btn-xs btn-success" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">View More <span class="caret"></span></NavLink>
                           ...
                           <td class=" ">0 </td>
                           <td class=" "><NavLink class="btn btn-success btn-xs" to=" http://park9.bet/report/openbethistory?user_id=145441&Usertype=4"> 0.00</NavLink>
                           </td>
                           <td class=" ">0 </td>
                           <td class=" ">0.00</td><td class=" ">0.00</td>                  
                                             <td class="last">
