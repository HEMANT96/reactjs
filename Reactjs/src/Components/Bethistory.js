...
function Bethistory(){   
	return(
		...
		<form method="post" id="formSubmit"  class="form-horizontal form-label-left input_mask"><input type="hidden" name="compute" value="fe6602731bf3d65605f0d8f6552a1c9f"/> 
			...
			<input type="text" name="from_date" value="2020-06-30" id="from-date" class="form-control col-md-7 col-xs-12 has-feedback-left" placeholder="From date" autocomplete="off"/>
		    </div>
		    <div class="popup_col_2">
			<input type="text" name="to_date" value="2020-06-30" id="to-date" class="form-control col-md-7 col-xs-12 has-feedback-left" placeholder="To date" autocomplete="off"/>
		    </div>
	    ...
	    <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <ul id="betsalltab" class="nav nav-pills match-lists">
                	<li class="active">
                        <NavLink to="http://park9.bet/bethistory/5" dat-attr="5">All</NavLink>
                    </li>
                    <li class="">
                        <NavLink to="http://park9.bet/bethistory/4" dat-attr="4">Cricket</NavLink>
                    </li>
                    <li class="">
                        <NavLink to="http://park9.bet/bethistory/2" dat-attr="2">Tennis</NavLink>
                    </li>
                    <li class="">
                        <NavLink to="http://park9.bet/bethistory/1" dat-attr="1">Soccer</NavLink>
                    </li>                        
                    <li class="">
                        <NavLink to="http://park9.bet/bethistory/9" dat-attr="9">Teenpatti</NavLink>
                    </li>
                    <li class="">
                        <NavLink to="http://park9.bet/bethistory/0" dat-attr="0">Fancy</NavLink>
                    </li>
                </ul>
            </div>
