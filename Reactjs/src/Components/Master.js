...
<button class="btn btn-warning btn-xs ml-1 pr-5" onclick="setAction()" >
ACTION
</button>
     <button class="btn btn-warning btn-xs ml-1 pr-5" onclick="addUser(145315,3)" >
ADD USER
</button>
           </div>
</div>
...
<div id="divLoading"></div>
 ...
 <td>1  <input type="checkbox" value="152052" class="select-users"/>
              </td>
              <td class="pb-0 ">
                 <span class="m-bg">
