...
function BlockMarket(){
  return(
         ...
         <div class="container-fluid pb- body">
	       <div class="main_container" id="sticky">
			...
			<button class="btn btn-xs ml-1  btn-primary" onclick="goBack()">Back</button>
            </div>
            </div>
              <div class="col-md-12  ">
					<div class="clearfix"></div>
					<div class="table table-striped jambo_table bulk_action" id="contentreplace">
	      <Table class="table tabelcolor tabelborder " size="sm" >
			<thead>
				<tr>
					<th scope="col">So.</th>
