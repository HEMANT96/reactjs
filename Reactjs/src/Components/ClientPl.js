...
function Clientpl(){
 ...
 <div class="container-fluid body">
    ...
    <div class="right_col" role="main">
		...
		<input type="hidden" name="ajaxUrl" id="ajaxUrl" value="clientpl"/>
	
        <form method="post" class="form-horizontal form-label-left " id="formSubmit"><input type="hidden" name="compute" value="fe6602731bf3d65605f0d8f6552a1c9f"/> 	
		    ...
		    <div class="col-sm-3 ml-0">
				...
				<NavLink to="http://park9.bet/clientpl"  class="red_button ml-"><i class="fa fa-eraser ml-1"></i> Clear</NavLink>
				<NavLink to="/" id="backbutton"  class="red_button pull-right"><i class="fa fa-eraser ml-1"></i> Back</NavLink>
			   {/* javascript:void(0); */}
			</div>
            </div>
		   </form>		   
		...
		<div class="custom-scroll data-background appendAjaxTbl">
		    ...
		    <table class="table table-striped jambo_table bulk_action full-table-clint" id ="datatable">
                <thead>	
				<tr class="headings">				
